...
use std::ffi::CString;
use spectral_holography::{ish_create_with_password, ish_encrypt_file, ish_decrypt_file, ish_encrypt_file_z1, ish_free_string, ish_extract_salt, ish_create_with_salt};
...
fn run_test_for_size(size: usize) {
    ...
    println!("  Expansion Ratio: {:.2}x (Overhead: {} bytes)", ratio, enc_size - size as u64);
